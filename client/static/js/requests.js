async function getAllUsers() {
  try {
    const response = await fetch(`https://habitat-7aey.onrender.com/user`);
...
async function getUserHabits() {
  ...
  try {
    ...
    const response = await fetch(
      `https://habitat-7aey.onrender.com/user/habits/${id}`,
      options
    );
    const data = await response.json();
    return data;
...
async function getUserSpecificHabits() {
  ...
  try {
    ...
    const response = await fetch(
      `https://habitat-7aey.onrender.com/user/habits/${id}/${habitId}`,
      options
    );
    const data = await response.json();
    return data;
...
async function getUserCompletedHabits() {
  ...
  try {
    ...
    const response = await fetch(
      `https://habitat-7aey.onrender.com/user/completed/${id}`,
      options
    );
    const data = await response.json();
    return data;
...
async function createNewHabit() {
  ...
  try {
    ...
    const r = await fetch(
      `https://habitat-7aey.onrender.com/user/habits/create`,
      options
    );
...
async function getProfileImages() {
  try {
    ...
    const response = await fetch(
      `https://habitat-7aey.onrender.com/user/profileImage`,
      options
    );
    const data = await response.json();
    return data;
